      ...
      {timeLeft ? (
        <div className="grid grid-cols-4 gap-2 md:gap-4 max-w-md mx-auto">
          <div className="bg-white/70 backdrop-blur-sm p-3 md:p-4 rounded-lg shadow">
            <div className="text-3xl md:text-4xl font-bold text-purple-700">{formatTime(timeLeft.days)}</div>
            <div className="text-xs md:text-sm text-gray-600 uppercase">Days</div>
          </div>
          <div className="bg-white/70 backdrop-blur-sm p-3 md:p-4 rounded-lg shadow">
            <div className="text-3xl md:text-4xl font-bold text-purple-700">{formatTime(timeLeft.hours)}</div>
            <div className="text-xs md:text-sm text-gray-600 uppercase">Hours</div>
          </div>
          <div className="bg-white/70 backdrop-blur-sm p-3 md:p-4 rounded-lg shadow">
            <div className="text-3xl md:text-4xl font-bold text-purple-700">{formatTime(timeLeft.minutes)}</div>
            <div className="text-xs md:text-sm text-gray-600 uppercase">Minutes</div>
          </div>
          <div className="bg-white/70 backdrop-blur-sm p-3 md:p-4 rounded-lg shadow">
            <div className="text-3xl md:text-4xl font-bold text-purple-700">{formatTime(timeLeft.seconds)}</div>
