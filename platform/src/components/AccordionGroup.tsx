  ...
  return (
    <div>
      {items.map((item, index) => (
        <div key={index} className="border border-dark-green rounded-lg mb-4 overflow-hidden bg-dark-base"> {/* Updated bg, border */}
          ...
          <details className="group">
            ...
            <div className="p-5 border-t border-t-dark-green text-light-text"> {/* Updated padding, border color, text color */}
