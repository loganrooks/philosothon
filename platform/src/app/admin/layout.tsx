    ...
    <div className="flex min-h-screen bg-gray-900 text-gray-100">
      ...
      <aside className="w-64 flex-shrink-0 border-r border-gray-700 bg-gray-800 p-4 flex flex-col"> {/* Added flex flex-col */}
        <div> {/* Wrapper for top content */}
          <h2 className="mb-6 text-xl font-semibold text-white">Admin Menu</h2>
          <nav className="space-y-2">
            <Link href="/admin" className="block rounded px-3 py-2 hover:bg-gray-700">
              Dashboard
            </Link>
            <Link href="/admin/themes" className="block rounded px-3 py-2 hover:bg-gray-700">
              Themes
            </Link>
            <Link href="/admin/workshops" className="block rounded px-3 py-2 hover:bg-gray-700">
              Workshops
            </Link>
            <Link href="/admin/faq" className="block rounded px-3 py-2 hover:bg-gray-700">
              FAQ
            </Link>
